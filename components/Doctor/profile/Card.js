        ...
        {data.map((item) => {
          return (
            ...
            <section className='col-4 mt-4 mb-4'>
                <Image src='/images/contact_rht.png' alt={item.name} fluid className='round-img' />
            </section>
            ...
            <div className="col-7 offset-1">  
              ...
              <ul className='card-list ms-4'>
                <li>Qualification : {item.description.profile}</li>
                <li>Speaks : {item.description.language}</li>
                <li>Experience : {item.description.experience}</li>
                <li>Profession : {item.description.job}</li>
                <li>Fees : {item.description.fee}</li>
              </ul>
